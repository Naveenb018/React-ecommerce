...
const WomensCollection = (props) => {
    const {title, image1, price1, image2, price2, image3,price3, image4, price4, image5,price5, image6,price6, image7,price7, image8,price8, image9,price9, image10, price10} = props.womenFashion
   
  return (
    <div className='collectionSection'>
    <h2>{title}</h2>
    <span id='lines-Women'>.........................................</span>
